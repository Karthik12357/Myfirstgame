...
# so what i did?
# coins hasn't collectable map they just in normal coin just must be 3 in that list. nothing else
...
player_image = pygame.image.load('Platformer game-BETA/Platformer game/player.png').convert_alpha()
player_image.set_colorkey((255, 255, 255))
coin = pygame.image.load("Platformer game-BETA/Platformer game/coin.png").convert_alpha()
spike_img = pygame.image.load('Platformer game-BETA/Platformer game/spike.png').convert_alpha()
img = pygame.image.load("Platformer game-BETA/Platformer game/crosshair-2.png").convert_alpha()
mountain_bg = pygame.image.load(
    "Platformer game-BETA/Platformer game/bg/glacial_mountains_lightened.png").convert_alpha()
clouds = pygame.image.load("Platformer game-BETA/Platformer game/bg/clouds_bg.png").convert_alpha()
grass_sound = pygame.mixer.Sound("Platformer game-BETA/Platformer game/grass_1.wav")
jump_sound = pygame.mixer.Sound("Platformer game-BETA/Platformer game/jump.wav")
menu_music = pygame.mixer.Sound("Platformer game-BETA/Platformer game/menu_music.wav")
pygame.mixer.Sound.set_volume(jump_sound, 10)
grass_sounds = [pygame.mixer.Sound('Platformer game-BETA/Platformer game/grass_0.wav'),
                pygame.mixer.Sound('Platformer game-BETA/Platformer game/grass_1.wav')]
click_sound = pygame.mixer.Sound("Platformer game-BETA/Platformer game/click.wav")
coin_collect_sound = pygame.mixer.Sound("Platformer game-BETA/Platformer game/coin_collect_sound.wav")
grass_sounds[0].set_volume(0.5)
grass_sounds[1].set_volume(0.5)
gameover=pygame.mixer.Sound("Platformer game-BETA/gameover.wav")
jumpland_sound = pygame.mixer.Sound("Platformer game-BETA/Platformer game/jumpland.wav")
jumpland_sound.set_volume(1)
earth_bg = pygame.image.load("Platformer game-BETA/Platformer game/world-globe_icon.png")
jumps = 0
earth = pygame.transform.scale(pygame.image.load("Platformer game-BETA/Platformer game/earth.bmp"),
                               (384, 384))  # you can past here any image
...
grass_image = pygame.image.load('Platformer game-BETA/Platformer game/grass.png')
TILE_SIZE = grass_image.get_width()

dirt_image = pygame.image.load('Platformer game-BETA/Platformer game/dirt.png')
...
def load_map_collectables(path):  # btw this function not used with my coin system
    f = open(path + '.txt', 'r')
    data = f.read()
    f.close()
    data = data.split('\n')
...
player_frame = 0
player_flip = False
animation_database = {'run': load_animation('Platformer game-BETA/Platformer game/player_animations/run', [7, 7]),
                      'idle': load_animation('Platformer game-BETA/Platformer game/player_animations/idle',
                                             [7, 40, 40])}

game_map = load_map('Platformer game-BETA/Platformer game/map')
collectables_map = load_map_collectables("Platformer game-BETA/Platformer game/cmap")
...
green_bg = "Platformer game-BETA/Platformer game/green_bg.jpg"
...
def game_loop():  # game loop
    ...
    jumps = 0
    pygame.mixer.music.load("Platformer game-BETA/Platformer game/music.wav")
    pygame.mixer.music.play(-1)
    pygame.mixer.music.set_volume(0.3)
    story=True
    story_time=0
    # i deleted menu function, cuz it was unused
